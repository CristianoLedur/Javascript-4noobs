console.log("1.5 - Básico - Operadores");

// Lógicos ->  são tipicamente usados com valores Booleanos (lógicos - TRUE/FALSE).

/* 
va1 %% var2-> AND =Retorna var1 caso possa ser convertido para FALSE; senão, retorna var2. Assim, quando utilizado com valores booleanos, && retorna TRUE caso ambos operandos sejam verdadeiros; caso contrário, retorna FALSE.
...
// Comparação -> retornam um valor lógico se a comparação é verdadeira.
